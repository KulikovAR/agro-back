...
Route::middleware(['guest'])->group(function () {
    ...
    Route::post('/registration/verification',[RegistrationController::class,'verification'])->name('verification');
    Route::post('/code/update',[RegistrationController::class,'codeUpdate'])->name('code.update');
